...
# creating an instance named "avengers" for the Movie class and
...
how_to_train = media.Movie("How to Train Your Dragon",
                           "https://upload.wikimedia.org/wikipedia/en/f/fd/"
                           "How_to_Train_Your_Dragon_3_poster.png",
